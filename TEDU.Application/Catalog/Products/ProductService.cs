...
namespace TEDU.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(TEDUDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new TEDUException($"Cannot find product with id:{request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new TEDUException($"Cannot find product with id : {productId}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            var productTransaction = await _context.ProductTranslations.FirstOrDefaultAsync(x => x.ProductId == productId && x.LanguageId == languageId);
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
                throw new TEDUException($"Cannot find an image with id{imageId}");
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new TEDUException($"Cannot find an with id{imageId}");
